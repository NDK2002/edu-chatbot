...
export default function AppShell({
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      {/* ── Desktop sidebar — hidden on /student (ConversationSidebar takes over) ── */}
      <aside className={`flex-col w-64 shrink-0 bg-white border-r border-gray-100 shadow-sm ${pathname.startsWith("/student") ? "hidden" : "hidden md:flex"}`}>
        {/* Logo */}
